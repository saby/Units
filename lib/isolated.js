...
function prepareTestEnvironment(projectRootPath, dependencies, patchedRequire, wsRootPath, emulateBrowser) {
   ...
   /** Эмуляция СП, будет убрано после https://online.sbis.ru/opendoc.html?guid=59f87611-f87f-404e-bb27-06350248d6b2 */
   process.domain = process.domain || {};
   process.domain.req = process.domain.req || {};
   process.domain.res = process.domain.res || {};
   requirejs('SbisEnv/StartApplication').default(cfg);
   return requirejs;
}
