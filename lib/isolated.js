...
exports.run = function (config) {
   ...
   try {
      require("home/sbis/workspace/ws.data_3.7.5/3.7.5/feature/multi-sort-filter/WS.Data/Adapter/Abstract");
   } catch (e) {
      console.log('require "home/sbis/workspace/ws.data_3.7.5/3.7.5/feature/multi-sort-filter/WS.Data/Adapter/Abstract" throws an error:');
      console.log(e);
   }
   try {
      require("/home/sbis/workspace/ws.data_3.7.5/3.7.5/feature/multi-sort-filter/WS.Data/Adapter/Abstract");
