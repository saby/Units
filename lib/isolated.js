...
exports.run = function (config) {
   ...
   requirejs = require(requirejsPath);
   ...
   var requirejsCfg = require(requirejsConfigPath)(
      projectRootPath,
      wsRootPath,
      wsResourcesPath,
      contents
   ...
   try {
      ...
      util.extend(TestConsoleLogger, ILogger);
   ...
   unit.test.getList(
      ...
      try {
         ...
         errors.push('Module "' + test + '" failed with error: ' + e);
      }
   });
