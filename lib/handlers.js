   ...
   return (req, res) => {
      try {
         ...
         if (config.moduleType == 'amd') {
            startupScripts.push(wsExists ? `${wsConfig.wsRoot}/ext/requirejs/require.js` : 'node_modules/requirejs/require.js');
         }
         if (config.moduleType == 'amd' && wsExists) {
            startupScripts.push(`${wsConfig.wsRoot}/ext/requirejs/config.js`);
         }
