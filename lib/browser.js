...
class Loader {
   ...
   getCoverageReport() {
      return new Promise((resolve, reject) => {
         ...
         driver.$('#coverageReport').getValue(false).then(text => {
   ...
   checkTestingFinished(driver) {
      return new Promise((resolve, reject) => {
         ...
         driver.$('body.tests-finished').isExisting().then(isExisting => {
            ...
            driver.$('#report').getValue(false).then(text => {
   ...
   checkTestingException(driver) {
      return new Promise((resolve, reject) => {
         ...
         driver.$('#exception').isExisting().then(isExisting => {
            ...
            driver.$('#exception').getText().then(text => {
